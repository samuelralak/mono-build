...
const MonoConnect = (props) => {
    ...
    const connect_url = React.useMemo(() => {
        const qs = Object.assign({ key: publicKey, code: otherConfig.reauth_token, scope: otherConfig === null || otherConfig === void 0 ? void 0 : otherConfig.scope, data: otherConfig === null || otherConfig === void 0 ? void 0 : otherConfig.data, reference: otherConfig === null || otherConfig === void 0 ? void 0 : otherConfig.reference, version: '2023-12-14' }, otherConfig);
        return createUrl(qs);
